...
// GetDestroyTimeoutSeconds returns CreateServiceInput.DestroyTimeoutSeconds, and is useful for accessing the field via an interface.
func (v *CreateServiceInput) GetDestroyTimeoutSeconds() *int { return v.DestroyTimeoutSeconds }
...
// GetDestroyTimeoutSeconds returns FindServiceServiceListServiceConnectionNodesService.DestroyTimeoutSeconds, and is useful for accessing the field via an interface.
func (v *FindServiceServiceListServiceConnectionNodesService) GetDestroyTimeoutSeconds() int {
	return v.DestroyTimeoutSeconds
}
...
// GetDestroyTimeoutSeconds returns UpdateServiceInput.DestroyTimeoutSeconds, and is useful for accessing the field via an interface.
func (v *UpdateServiceInput) GetDestroyTimeoutSeconds() *int { return v.DestroyTimeoutSeconds }
